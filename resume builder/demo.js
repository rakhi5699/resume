...
$("#objective").click(function(){
      ...
      $("#name").hide(1000)
      //it showing bcs objective clicked
 ...
 $("#education").click(function(){
      ...
      //it showing bcs education clicked
...
$("#tskills").click(function(){
      ...
      $("#object-name").hide(1000)
      $("#education-name").hide(1000)
      //it showing bcs technical skills clicked
...
$("#projects").click(function(){
  ...
  $("#education-name").hide(1000)
  $("#tskills-name").hide(1000)
  //it showing bcs projects clicked 
...
$("#activite").click(function(){
  ...
  $("#tskills-name").hide(1000)
  $("#projects-name").hide(1000)
  //it showing bcs activites clicked 
...
$("#pskills").click(function(){
  ...
  $("#projects-name").hide(1000)
  $("#activite-name").hide(1000)
  //it showing bcs personal skills clicked 
